...
# Chapter 04 Nonparametric Comparison of Survival Distributions -----------
...
# Note:  "pancreatic2" is already part of the "asaur" package; 
# this is how one would create it:
#pancreatic2 <- data.frame(pfs, os, status, stage)    
# create "pancreatic2" data frame

# library(pancreatic2) 
# an alternative to the above is to just use pancreatic2
pfs.month <- pfs/30.5
...
detach(pancreatic)     # make the variable names accessible
...
legend("topright", 
    legend=c("control mutant", "treated mutant", "control wildtype", 
             "treated wildtype"),
