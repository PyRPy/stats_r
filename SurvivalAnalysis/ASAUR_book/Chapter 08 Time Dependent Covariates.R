...
# naive analysis
coxph(Surv(futime, fustat) ~ transplant, data=heart.simple)
...
# leave off the dates and transplant-specific covariates, temporary data set
...
head(jasa.counting)
summary(coxph(Surv(tstart, tstop, death) ~ trans + surgery + age, 
              data=jasa.counting))
