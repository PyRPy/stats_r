...
# click on points to get their identifying label.
#   Press the "Esc" button to quit the "identify" mode.
detach(pharmacoSmoking)

# # # # # # # # # # # # # #
# Section 7.2.1 checking the proportional hazards assumption; 
...
# # # # # # # # # # # # # #
# Section 7.2.2 checking the proportional hazards assumption; 
