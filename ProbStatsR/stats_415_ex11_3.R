...
# https://online.stat.psu.edu/stat415/lesson/11/11.3
...
# two-sample t-test  ------------------------------------------------------
t.test(dinopis, menneus, alternative = "two.sided", var.equal = TRUE)
...
# Welch's t-Interval ------------------------------------------------------
t.test(dinopis, menneus, alternative = "two.sided", var.equal = FALSE)
