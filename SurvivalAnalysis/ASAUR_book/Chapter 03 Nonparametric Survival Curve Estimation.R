...
# 3.2 Finding the Median Survival and a Confidence Interval for th --------
...
# Figure 3.4.3 Kaplan-Meier survival plot and smoothed survival 
# estimate for gastricXelox data
